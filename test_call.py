"""
Single-call test dialer. Calls YOUR number so you can pressure-test Mike
...
def main() -> None:
    ...
    ap.add_argument("--name", default=DEFAULT_TEST_NAME, help="first name Mike uses")
